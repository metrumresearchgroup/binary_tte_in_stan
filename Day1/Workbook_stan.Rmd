...
Look at convergence diagnostics:
  ...
  - Trace plots
  - density plots
Look at posterior summaries for parameters (summary(mod01_stan))
...
Check the default prior distributions using `prior_summary`
...
TODO: Add priors explicitly: normal distributions


```{r}
mod01_normal_stan <- brm(formula = AE01 ~ CAVGSS + BWT + PTTYPE + SEXTXT,  
                         data=dat_mod, 
                         family = bernoulli(link = "logit"),
...
* Modify model to use t-distirbutions with 3 degrees of freedom.  How do the estimates and CIs change?
