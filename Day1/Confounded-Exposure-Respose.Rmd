...
# Understanding exposure-response relationships is a key componant of decision-making:
...
* The apparent exposure-response in the ToGA trial was an artifact of `counfounding`
...
* If we're not careful, basline disease severity can counfound the causal relationship between exposure and survival
...
* Weight: baseline factor indirectly affecting exposure (through CL)  
* Disease severity: baseline factor directly affecting outcome and indirectly affecting exposure 
* Does the extra informantion help?
