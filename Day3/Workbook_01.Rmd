...
* Fit a model or two using alternative parametric families (Gamma, lognormal, or Freshet).  Include both relative tumor size at Day 84 and baseline ECOG status.
