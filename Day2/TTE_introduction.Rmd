...
::::{.column}
```{r, ref.label="coxpred", echo=FALSE}
...
# Workbook
   ...
   - Extracting parameter estimates and confidence intervals
...
# Smooth non-parametric hazard functions 
...
* Time-varying covariates 
    - Extension to the standard Cox model
